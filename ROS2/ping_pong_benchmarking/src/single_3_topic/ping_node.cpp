...
#include "single_3_topic/ping_node.hpp"
...
Ping::Ping() : rclcpp::Node("ping"){
    ...
    pong_1_sub = this->create_subscription<std_msgs::msg::UInt32>("/pong_1", default_qos, std::bind(&Ping::onPong1Callback, this, _1));
    ping_1_pub = this->create_publisher<std_msgs::msg::UInt32>("/ping_1", default_qos);
    pong_2_sub = this->create_subscription<std_msgs::msg::UInt32>("/pong_2", default_qos, std::bind(&Ping::onPong2Callback, this, _1));
    ping_2_pub = this->create_publisher<std_msgs::msg::UInt32>("/ping_2", default_qos);
    pong_3_sub = this->create_subscription<std_msgs::msg::UInt32>("/pong_3", default_qos, std::bind(&Ping::onPong3Callback, this, _1));
...
void Ping::store_data(){
    ...
    // Ping Pong Topic 1
    data_file.open("./ping_pong_benchmarking/data/single_3_topic/pingpong_data_1.txt");
    ...
    data_file.open("./ping_pong_benchmarking/data/single_3_topic/pingpong_latency_1.txt");
    ...
    data_file.open("./ping_pong_benchmarking/data/single_3_topic/pingpong_results_1.txt");
    ...
    // Ping Pong Topic 2
    data_file.open("./ping_pong_benchmarking/data/single_3_topic/pingpong_data_2.txt");
    ...
    data_file.open("./ping_pong_benchmarking/data/single_3_topic/pingpong_latency_2.txt");
    ...
    data_file.open("./ping_pong_benchmarking/data/single_3_topic/pingpong_results_2.txt");
    ...
    // Ping Pong Topic 3
    data_file.open("./ping_pong_benchmarking/data/single_3_topic/pingpong_data_3.txt");
    ...
    data_file.open("./ping_pong_benchmarking/data/single_3_topic/pingpong_latency_3.txt");
    ...
    data_file.open("./ping_pong_benchmarking/data/single_3_topic/pingpong_results_3.txt");
